<template>
  <div class="relative">
    <div @click="toggleCustomRate" class="flex items-center justify-center cursor-pointer w-8 h-6 relative hover:bg-gray-50 dark:hover:bg-gray-500 dark:bg-gray-600 bg-gray-100 rounded-lg focus:outline-none focus:ring-1 focus:ring-black focus:ring-opacity-20">
    ...
    >
      <div class="absolute z-50 w-48 mt-2 right-0" v-if="isOpen">
        <div class="relative flex flex-col space-y-2 py-2 border-l-2 border-oswapGreen shadow-lg rounded-lg p-1 px-2 bg-gray-100 dark:bg-gray-600">
          ...
          <InputWithValidation :input="amount" :errors="errors" @catchInput="inputAmount" :rounded="'rounded-lg'" :placeholder="'%'" :errorTop="'pt-8'">
