<template>
  <div id="walletState" class="pl-3">
    ...
    <div v-show="connected === false" class="flex w-44 items-center text-gray-500 space-x-1 pr-2 p-1 rounded-lg dark:bg-gray-700 dark:hover:bg-gray-600 bg-gray-200 hover:bg-gray-100 cursor-pointer ring-1 ring-black ring-opacity-5">
    ...
    <div v-show="connected" class="flex w-44 items-center space-x-1 pr-2 p-1 rounded-lg bg-opacity-20 hover:bg-opacity-50 cursor-pointer border-oswapGreen-dark border glow-oswapGreen-light-md">
