<template>
  <div class="relative">
    <div @click="toggleCustomRate" :class="checkCustom ? 'border-l-2 border-oswapGreen' : 'hover:bg-gray-50 dark:hover:bg-gray-500'" class="flex items-center justify-center cursor-pointer w-8 h-6 relative hover:bg-gray-50 dark:hover:bg-gray-500 dark:text-gray-300 dark:bg-slightDark bg-slightGray rounded-lg focus:outline-none focus:ring-1 focus:ring-black focus:ring-opacity-20">
