<template>
  <div class="flex w-full ss:mt-3 ss:mb-6 xs:mt-8 xs:mb-12">
    <div class="flex ss:flex-1 xs:flex-none flex-col mdd:flex-row ss:h-344 xs:h-408 mdd:h-216 bg-gradient-to-l from-slightGray dark:from-slightDark to-transparent p-3 rounded-3xl">
